...
@Component({
  ...
  templateUrl: './plantwise-multitasking.component.html',
  styleUrls: ['./plantwise-multitasking.component.scss']
})
export class PlantwiseMultitaskingComponent implements OnInit {
