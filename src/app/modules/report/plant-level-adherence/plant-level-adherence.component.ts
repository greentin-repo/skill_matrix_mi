...
@Component({
  ...
  templateUrl: './plant-level-adherence.component.html',
  styleUrls: ['./plant-level-adherence.component.scss']
})
export class PlantLevelAdherenceComponent implements OnInit {
