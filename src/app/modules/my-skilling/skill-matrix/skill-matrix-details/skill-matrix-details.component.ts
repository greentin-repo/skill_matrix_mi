...
@Component({
  ...
  templateUrl: './skill-matrix-details.component.html',
  styleUrls: ['./skill-matrix-details.component.scss']
})
export class SkillMatrixDetailsComponent implements OnInit {
  ...
  constructor(
    ...
    private appService: SkillMatrixService,
  ) { }
  ...
  getOJTRegistrationDetails() {
    this.appService.getSkillMatrixetails('apis/sm/getOJTRegistrationDetails/' + this.selectedDetail.ojtRegisId).subscribe((response: any) => {
